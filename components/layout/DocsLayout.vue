...
css({
  ...
  '.aside-nav': {
    ...
    '@lg': {
      display: 'block',
      position: 'sticky',
      top: '{docux.app.header.height}',
      alignSelf: 'flex-start',
      height: 'calc(100vh - {docux.app.header.height})',
      py: '{docux.layout.docs.spacing}',
      paddingInlineEnd: '{docux.layout.docs.spacing}',
    }
  },
  '.page-content': {
    position: 'relative',
  ...
  '.toc': {
    ...
    '@lg': {
      mx: 0,
      alignSelf: 'flex-start',
      padding: '{docux.layout.docs.spacing}',
