...
export default defineComponent({
  props: {
    ...
    owner: {
      type: String,
      default: () => useAppConfig()?.docux?.github?.owner,
      required: false
    },
    /**
     * Repository name.
    ...
    repo: {
      type: String,
      default: () => useAppConfig()?.docux?.github?.repo,
      required: false
    },
    /**
    ...
    branch: {
      type: String,
      default: () => useAppConfig()?.docux?.github?.branch,
      required: false
    },
    /**
    ...
    dir: {
      type: String,
      default: () => useAppConfig()?.docux?.github?.dir,
      required: false
    },
    /**
     * Source file path.
    ...
    contentDir: {
      type: String,
      required: false,
      default: () => useAppConfig()?.docux?.github?.dir || 'content'
    },
    /**
    ...
    edit: {
      type: Boolean,
      required: false,
      default: () => useAppConfig()?.docux?.github?.edit
    }
  },
  setup (props) {
